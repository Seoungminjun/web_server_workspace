...
public class MemberServiceTest {
    ...
    @Test
    public void test3(){
        Member member = memberService.findById("asdfasdfsfdsffd");
    ...
    public void test9() {
        ...
        assertThat(member2.getBirthday()).isEqualTo(newBrithday);
