...
public class ListStringTypeHandler extends BaseTypeHandler<List<String>> {
    /**
     * List 요소를 꺼내서 , 기준으로 연결해 하나의 문자열 반환
     *
    ...
    @Override
    public List<String> getNullableResult(ResultSet resultSet, int columnIndax) throws SQLException {
        String value = resultSet.getString(columnIndax);
        if (value != null) {
            return Arrays.asList(value.split(","));
        }
        return null;
