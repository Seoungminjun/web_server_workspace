    ...
    JSTL
     ...
     - JSP에서 사용가능한 액션태그의 한 종류
        ...
        - 커스텀액션태그 <c:xxx>, <fmt:xxx>, ${fn:xxx}
            - jstl.jar 의존 추가 후 taglib등록 후 사용
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %> <%-- 이 3개는 매 jsp에 필요하다. --%>
<html>
<head>
...
<body>
    ...
    <div>
        <%-- 독서, 넷플릭스, 게임, 맛집투어 --%>
        <c:forEach items="${hobbies}" var="z" varStatus="zs">
            ${z}${zs.last ? '' : ', '}
        </c:forEach>
    </div>
    ...
    <ul>
        <li>
            <fmt:formatNumber value="${no1}" pattern="#,###"/> <%-- 뒤에 지울라면 / 필수 --%>
        </li>
        <li>
