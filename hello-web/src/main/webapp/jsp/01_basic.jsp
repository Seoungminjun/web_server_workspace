<%--
  ...
  내장객체 (선언없이 사용 할 수 있는 객체)
  1. context 객체(서버운영에 필요한 정보를 가지고, 각기 다른 생명주기를 가진 객체)
    - pageContext : PageContext (생명주기 : JSP처리기간)
    - request : HttpServletRequest (사용자 요청정보를 가진 객체, 생명주기 : 요청 ~ 응답)
    - session : HttpSession (생명주기 : 사용자 첫접속 ~ 접속해제)
    - application : ServletContext (생명주기 : 서버시작 ~ 서버 종료)
